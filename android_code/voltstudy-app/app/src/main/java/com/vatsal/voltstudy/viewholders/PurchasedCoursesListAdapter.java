...
public class PurchasedCoursesListAdapter extends RecyclerView.Adapter<PurchasedCoursesListAdapter.MyCoursesListViewHolder> {
    ...
    // Constructors
    public PurchasedCoursesListAdapter(Context mContext, ArrayList<String> courseName, ArrayList<String> courseAuthor,
    ...
    @NonNull
    @Override
    public MyCoursesListViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_course_vert_list, parent, false);

        return new MyCoursesListViewHolder(view);
    }

    // This method binds those controls inside the view to their respective controls
    @Override
    public void onBindViewHolder(@NonNull final MyCoursesListViewHolder holder, int position) {
    ...
    public class MyCoursesListViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyCoursesListViewHolder(View itemView) {
            super(itemView);
