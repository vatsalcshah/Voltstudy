...
import com.vatsal.voltstudy.viewholders.PurchasedCoursesListAdapter;
 ...
 * Use the {@link PurchasedCoursesFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class PurchasedCoursesFragment extends Fragment {

    private FirebaseAuth auth;

    private RecyclerView mRecyclerViewCourse;
    private PurchasedCoursesListAdapter courseAdapter;

    private ProgressBar progressBar;
    CardView notSignedIn,notPurchased;
    ...
    public PurchasedCoursesFragment() {
     ...
     * @return A new instance of fragment PurchasedCoursesFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static PurchasedCoursesFragment newInstance(String param1, String param2) {
        PurchasedCoursesFragment fragment = new PurchasedCoursesFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View viewLayout = inflater.inflate(R.layout.fragment_purchased_courses, container, false);

        auth = FirebaseAuth.getInstance();

        progressBar = viewLayout.findViewById(R.id.progress_my_courses);

        if(auth.getCurrentUser()!= null) {
            mRecyclerViewCourse = viewLayout.findViewById(R.id.rvMyCourses);
            courseAdapter = new PurchasedCoursesListAdapter(getActivity(), courseName, courseAuthor, courseLanguage, courseCode, courseCategory, courseSubCategory, courseImageUrl, courseType, coursePrice);
            progressBar.setVisibility(View.VISIBLE);
            getFirebaseCourseData();
        }
        else {
            notSignedIn = viewLayout.findViewById(R.id.card_not_signed_in);
            notSignedIn.setVisibility(View.VISIBLE);
            progressBar.setVisibility(View.GONE);
            btnSignIn = viewLayout.findViewById(R.id.sign_up_button_unlock);
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        if (dataSnapshot.exists()) {
                            ...
                            notPurchased = getView().findViewById(R.id.card_not_purchased);
                            notPurchased.setVisibility(View.VISIBLE);
                            btnNPHome = getView().findViewById(R.id.btn_my_courses_to_home);
                            btnNPHome.setOnClickListener(view -> {
                                startActivity(new Intent(getActivity(), HomeActivity.class));
                                getActivity().overridePendingTransition(0, 0);
                            });
                            btnNPSearch = getView().findViewById(R.id.btn_my_courses_to_search);
    ...
    private void fetchCourseData(DataSnapshot singleSnapshot) {
        PurchasedCourses course = singleSnapshot.getValue(PurchasedCourses.class);
    ...
    public void onCreateOptionsMenu(@NonNull Menu menu, @NonNull MenuInflater inflater) {
        ...
        inflater.inflate(R.menu.menu_purchased_courses, menu);
    }
}